...
- Name: usingExcleData.spec.ts >> ERp Management Module >> Stock Test Second Category 2
...
Call log:
  - waiting for locator('#elh_a_stock_items_Unit_Of_Measurement')
    - locator resolved to <label for="x_Unit_Of_Measurement" class="col-sm-4 control-label ewLabel" id="elh_a_stock_items_Unit_Of_Measurement">…</label>
...
> 79  |             await this.UnitOfMeasurement.selectOption(measure)
      |                                          ^ Error: locator.selectOption: Test timeout of 30000ms exceeded.
