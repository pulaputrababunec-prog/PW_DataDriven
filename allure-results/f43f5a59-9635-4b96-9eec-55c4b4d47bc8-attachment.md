...
```
Error: locator.click: Error: strict mode violation: locator('text=OK') resolved to 7 elements:
    ...
    7) <button class="ajs-button btn btn-primary">OK!</button> aka getByRole('button', { name: 'OK!' })

Call log:
  - waiting for locator('text=OK')
