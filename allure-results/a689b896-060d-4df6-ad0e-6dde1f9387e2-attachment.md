...
- Name: UsingJsonData.spec.ts >> ERP Managent Modules >> Stock With Json data Stock-000000058
- Location: tests\UsingJsonData.spec.ts:57:17

# Error details

```
Error: page.goto: net::ERR_INTERNET_DISCONNECTED at http://webapp.qedgetech.com/
Call log:
