...
- Name: usingExcleData.spec.ts >> ERp Management Module >> Stock Test First Category 1
...
Call log:
  - waiting for locator('select#x_Unit_Of_Measurement')
    - locator resolved to <select class="form-control" data-value-separator=", " data-table="a_stock_items" id="x_Unit_Of_Measurement" name="x_Unit_Of_Measurement" data-field="x_Unit_Of_Measurement">…</select>
