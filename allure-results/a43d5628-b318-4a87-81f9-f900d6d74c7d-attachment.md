...
Call log:
  - waiting for locator('text=Stock Items').filter({ hasText: 'Stock Items' }).first()
    - locator resolved to <a class="ewDropdown" href="a_stock_itemslist.php?cmd=resetall">…</a>
...
> 42 |             await this.clickStockItemsLink.first().hover()
     |                                                    ^ Error: locator.hover: Test timeout of 30000ms exceeded.
