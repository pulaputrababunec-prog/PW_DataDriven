...
```
Error: locator.hover: Error: strict mode violation: locator('text=Stock Items').filter({ hasText: 'Stock Items' }) resolved to 2 elements:
...
Call log:
  - waiting for locator('text=Stock Items').filter({ hasText: 'Stock Items' })
...
```ts
  ...
  24 |         this.clickStockItemsLink = page.locator('text=Stock Items',{hasText:'Stock Items'})
  25 |         //#mi_a_stock_categories
  26 |         this.clickstockcategoryLink = page.locator('text=Stock Categories',{hasText:'Stock Categories'})
...
> 42 |             await this.clickStockItemsLink.hover()
  ...
  45 |             await this.clickstockcategoryLink.first().click()
  46 |         }
  47 | 
