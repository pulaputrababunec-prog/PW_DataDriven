...
```
Error: locator.waitFor: Error: strict mode violation: locator('text=Stock Categories') resolved to 2 elements:
    1) <a href="a_stock_categorieslist.php">Stock Categories</a> aka locator('#mmi_a_stock_categories').getByText('Stock Categories')
    2) <a href="a_stock_categorieslist.php">Stock Categories</a> aka locator('#mi_a_stock_categories').getByText('Stock Categories')

Call log:
  - waiting for locator('text=Stock Categories') to be visible
