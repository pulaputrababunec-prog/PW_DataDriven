...
Call log:
  - waiting for locator('input[placeholder=\'Category Name\']') to be visible
...
```ts
  ...
  24 |         this.clickstockcategoryLink = page.locator('#mi_a_stock_categories')
  ...
  49 | 
> 50 |             await this.categoryNameInput.waitFor()
     |                                          ^ Error: locator.waitFor: Test timeout of 30000ms exceeded.
  51 |             this.expNumber = await this.categoryNameInput.inputValue()
  52 |            
  53 |         } 
  54 |         
