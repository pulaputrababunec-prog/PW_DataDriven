...
Call log:
  - waiting for locator('text=Add').first()
    - locator resolved to <a href="breadcrumblinksaddsp.php">Add New Breadcrumb Links</a>
  ...
  - element was detached from the DOM, retrying
    - locator resolved to <button type="button" class="btn btn-primary ewButton">Add</button>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is not visible
    - retrying click action
