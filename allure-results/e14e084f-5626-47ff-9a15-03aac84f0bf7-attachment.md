...
Call log:
  - waiting for locator('#elh_a_stock_items_Supplier_Number')
    - locator resolved to <label for="x_Supplier_Number" id="elh_a_stock_items_Supplier_Number" class="col-sm-4 control-label ewLabel">…</label>
